                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="bg-gray-100 rounded-lg p-6">
                        ...
                        <div class="flex items-center justify-between" onclick="copyToClipboard()">
                            <p class="text-3xl sm:text-2xl md:text-3xl font-bold text-blue-500 mr-4" id="invitationCode">{{ $invitationCode }}</p>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mb-4">
                            <p><span class="font-bold text-lg sm:text-xl md:text-2xl">1. 招待コードを友達に送る</span><br>
                                <span class="text-gray-700 text-base sm:text-lg md:text-xl">友達に招待コードを送信してください。コードは登録時に必要となります。</span>
                            </p>
                        </div>
                        <div class="mb-4">
                            <p><span class="font-bold text-lg sm:text-xl md:text-2xl">2. 登録時に招待コードを使用</span><br>
                                <span class="text-gray-700 text-base sm:text-lg md:text-xl">友達が登録する際に、招待コードを入力するように依頼してください。<br>
                                    友達が招待コードを使って登録すると、両方に500ポイントが付与されます。</span>
                            </p>
                        </div>
                        <div>
                            <p><span class="font-bold text-lg sm:text-xl md:text-2xl">3. ポイントの利用</span><br>
                                <span class="text-gray-700 text-base sm:text-lg md:text-xl">ポイントは商品の購入時に利用できます。購入手続きの際にポイントを選択してください。</span>
                            </p>
                        </div>
                    </div>
                </div>
